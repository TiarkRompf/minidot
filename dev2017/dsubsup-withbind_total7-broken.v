...
| vsmatch: forall n, vset n -> list (vset (S n)) -> list (vset (S n)) -> vset_match n
.                                
...
Program Fixpoint val_type n (env: list (vset (S n))) (GH:list (vset (S n))) (T:ty) (dd: vset n) (v:vl) {measure (tsize_flat T)}: Prop :=
  match v,T with
