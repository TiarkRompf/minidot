...
Proof.
  intros. induction H0;
    ...
    try solve [split; try split; intros; inversion IHstp2_1 as [? [? ?]]; inversion IHstp2_2 as [? [? ?]]; inversion IHstp2_3 as [? [? ?]]; eauto; eapply stp2_all; eauto using stp2_closure_extend].
Qed.
