...
Lemma stpd2_untrans_aux: forall n, forall m G1 G2 G3 T1 T2 T3 n1,
  stp2 m G1 T1 G2 T2 nil n1 -> n1 < n ->
  stpd2 true G2 T2 G3 T3 nil ->
  stpd2 true G1 T1 G3 T3 nil.
Proof.
...
Proof.
  ...
  - Case "sela1".
    ...
    + SCase "x = 0".
      ...
      * subst. simpl.
        eapply IHstp2; eauto; try omega. right. right. left. auto.
