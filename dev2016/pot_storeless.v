...
Lemma stpd_fld: forall GH l T2 T4,
    stpd GH T2 T4 ->
    stpd GH (TFld l T2) (TFld l T4).
...
Proof.
  ...
  - Case "fld". eapply stpd_fld; eauto.
...
Proof.
  ...
  - Case "fld". subst.
    eapply stpd_fld. eapply IHn; eauto. omega.
  - Case "mem". subst.
...
Proof.
  ...
  - unfold substt in *.
    ...
    inversion H12; subst. eapply closed_open. simpl. eauto.
    econstructor.
    eapply (proj2 (proj2 (proj2 (proj2 closed_upgrade_rec)))). eauto. omega.
