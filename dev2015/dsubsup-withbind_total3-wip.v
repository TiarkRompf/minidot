...
Proof.
  ...
  - Case "Sel1".
    ...
    assert (vtp G GHX TX vf (uf (varF x) :: ub :: i)). specialize (H3 vf (ub :: i)). 
...
Proof.
  ...
  - (*TSel*) remember (TSel v) as T1. 
    ...
    inversion H1; subst.  
    (*indu*)
    specialize (H3 (varH 0) _ _ H2). ev. 
