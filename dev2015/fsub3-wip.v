...
Proof.
  ...
  - Case "True".
    ...
    + eapply not_stuck. eapply v_bool; eauto. eauto.
  ...
  - Case "Var".
    ...
    + destruct (index_safe_ex senv venv0 env T1 i) as [v [I V]]; eauto. 
      rewrite I. eapply not_stuck. eapply V. eauto.

    + eapply restp_widen. eapply IHhas_type; eauto. eapply stpd2_upgrade. eapply stp_to_stp2; eauto. econstructor.

  - Case "Typ".
    remember (ttyp t) as e. induction H0; inversion Heqe; subst.
    + eapply not_stuck. eapply v_ty; eauto. eapply stpd2_upgrade. eapply stp_to_stp2; eauto. econstructor. eauto.
    + eapply restp_widen. eapply IHhas_type; eauto. eapply stpd2_upgrade. eapply stp_to_stp2; eauto. econstructor.
  ...
  - Case "App".
    ...
    +
      ...
      assert (res_type venv0 senv rf (TFun T1 T2)) as HRF. SCase "HRF". subst. eapply IHn; eauto. eauto.
      inversion HRF as [? ? ? vf].
      ...
      assert (res_type ((x0,vx)::(f0,vf)::env1) senv res T4) as HRY.
        SCase "HRY".
          ...
          eauto. eauto. (* TODO: sstpd2_fun constructor *)
  ...
  - Case "Abs".
    ...
    + eapply not_stuck. eapply v_abs; eauto. rewrite (wf_fresh senv venv0 env H1). eauto. eapply stpd2_upgrade. eapply stp_to_stp2. eauto. eauto. econstructor. eauto.
    + eapply restp_widen. eapply IHhas_type; eauto. eapply stpd2_upgrade. eapply stp_to_stp2; eauto. econstructor.
  ...
  - Case "TAbs".
    ...
    + eapply not_stuck. eapply v_tabs; eauto. subst i. eauto. rewrite (wf_fresh senv venv0 env H1). eauto. eapply stpd2_upgrade. eapply stp_to_stp2. eauto. eauto. econstructor. eauto.
    +  eapply restp_widen. eapply IHhas_type; eauto. eapply stpd2_upgrade. eapply stp_to_stp2; eauto. econstructor.
