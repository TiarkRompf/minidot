  ...
  match v,T with
    ...
    | _, TBind T1 =>
      ...
      *)
      ...
      exists jj, jj n = dd /\ forall n, val_type env (jj::GH) (open (varH (length GH)) T1) n (jj n) v
...
(* this lemma  establishes that val_type indeed defines a vseta.
...
(* used in valtp_widen *)
Lemma valtp_closed: forall df vf GH H1 T1 n,
